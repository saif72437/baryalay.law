...
function PartnerProfileAllLawsSection() {
    const allLaws = [
    ...
    return (
        <div className="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3  gap-6 px-4 sm:px-8 md:px-16 pt-16">
...
export default PartnerProfileAllLawsSection;
